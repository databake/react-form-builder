...
var DynamicOptionList = require('../src/dynamic-option-list').default
  ...
  options: [
    {
      ...
      key: 'radiobuttons_option_94F7A605-B64A-4493-8C6C-9BD564CD688A',
    },
    {
      value: 'place_holder_option_2',
      text: 'Place holder option 2',
      key: 'radiobuttons_option_24A3BBEC-2899-4851-996C-D70E0B43AE62',
    },
    {
      value: 'place_holder_option_3',
      text: 'Place holder option 3',
      key: 'radiobuttons_option_CCE27C69-C13B-49F3-8CE1-6BD51B106F26',
    },
  ],
}
...
describe('<DynamicListOption />', function () {
  before('render and locate element', function () {
    ...
    this.dynamicOptionElement = ReactDOM.findDOMNode(
      this.dynamicOptionComponent
    )
  })
  ...
  it('should be able to update values', function () {
    var optionBoxes = this.dynamicOptionElement.querySelectorAll(
      'input[type=text]'
    )
